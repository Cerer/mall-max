			...
			<view class="tui-content__box">
				<view class="tui-my__assets">
					...
					<image @tap="toggle" mode="widthFix"
						:src="'/static/images/money/'+(isShow?'img_show_3x.png':'img_hide_3x.png')"></image>
				</view>

				<view class="tui-assets__center">
					<view class="tui-item__box">
						<text>余额</text>
						<view v-if="isShow">￥<text class="tui-text__large">128</text>.80</view>
				...
				<view class="tui-assets__bottom" style="padding: 15rpx 100rpx;">
					<view class="tui-item__box" @tap="coupon">
						<text>优惠券</text>
						<view v-if="isShow"><text class="tui-text__large">15</text>张</view>
						<view v-else><text class="tui-text__large">****</text></view>
					</view>
					<view class="tui-item__box" @tap="integral">
						<text>积分</text>
						<view v-if="isShow"><text class="tui-text__large">1000</text></view>
						<view v-else><text class="tui-text__large">****</text></view>
					</view>
				</view>
			...
			<view class="tui-recharge__box">
				...
				<view class="tui-list-cell">
					<view class="tui-amount__box">
						...
						<tui-button type="warning" width="142rpx" height="50rpx" shape="circle" :size="24" @click="recharge">立即充值</tui-button>
					</view>
					<view class="tui-amount__box">
...
<style scoped>
	...
	.tui-content__box {
		...
		position: relative;
		box-shadow: 0 3rpx 20rpx rgba(255, 71, 10, 0.2);
	}
