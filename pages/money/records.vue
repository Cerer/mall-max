...
<template>
	<view class="container">
		<tui-tabs :tabs="tabs" :currentTab="currentTab" selectedColor="#fa436a" sliderBgColor="#fa436a" itemWidth="33%"
			@change="change">
		</tui-tabs>
			...
			<view v-for="(item,index) in recordsList" :key="index" v-show="currentTab==index">
				<tui-list-cell :hover="false" v-for="(model,subIndex) in item.data" :key="subIndex">
					<view class="tui-records__item">
						<image class="tui-icon" :src="'/static/images/money/'+ model.icon"></image>
						<view>
