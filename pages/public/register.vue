		...
		<view class="wrapper">
			...
			<view class="input-content">
				...
				<view class="input-item">
					...
					<view class="verify-code">
						<input type="mobile" value="" placeholder="6位验证码" maxlength="6" data-key="verifyCode"
							@input="inputChange" style="width: 60%;" />
				...
				<view class="input-item">
					...
					<input type="mobile" value="" placeholder="8-18位数字、字母组合" placeholder-class="input-empty"
						maxlength="20" data-key="password" @input="inputChange" @confirm="doRegister" />
				</view>
			</view>
